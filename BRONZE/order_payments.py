...
# DBTITLE 1,Read CSV
df_order_payments = spark.read.csv("/Volumes/retail_project_b3/landing/raw_data/olist_order_payments_dataset.csv",header =True, inferSchema = True)
...
df_order_payments = df_order_payments.withColumn("ingest_ts",current_timestamp())
...
df_order_payments.write.mode("overwrite").format("parquet").save(f"/Volumes/retail_project_b3/bronze/order_payements/")
