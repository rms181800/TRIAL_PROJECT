...
# DBTITLE 1,Read CSV
df_order_reviews = spark.read.csv("/Volumes/retail_project_b3/landing/raw_data/olist_order_reviews_dataset.csv",header =True, inferSchema = True)
...
df_order_reviews = df_order_reviews.withColumn("ingest_ts",current_timestamp())
...
df_order_reviews.write.mode("overwrite").format("parquet").save(f"/Volumes/retail_project_b3/bronze/order_review/")
